...
from . import zero_mlx_tests as mlx_tests
import numpy as np


class TestCompile(mlx_tests.MLXTestCase):
    def x_test_simple_compile(self):
        def fun(x, y):
            return x + y
    ...
    def x_test_compile_tuple_output_in_thread(self):
        @mx.compile
        def fun(x):
            return x + 1, x * 2
    ...
    def x_test_compile_inputs_with_primitives(self):
        x = mx.array([1, 2, 3])
        y = mx.array([1, 2, 3])
        for _ in range(5):
            x = x + y
    ...
    def x_test_compile_with_closure(self):
        x = mx.array(1)
    ...
    def x_test_function_creates_array(self):
        def fun(x):
            return x + mx.array(1)
    ...
    def x_test_enable_disable(self):
        def fun(x):
            y = x + 1
            z = x + 1
            return y + z
    ...
    def x_test_compile_two_input_grad(self):
        def loss(w, x):
            y = x * w
    ...
    def x_test_vjp_vjp_compiled(self):
        def simple_unary(x):
            return -mx.exp(x)
    ...
    def x_test_transform_over_eval_compiled(self):
        def outer(x):
            y = mx.exp(mx.abs(x))
            mx.eval(y)
            return y.sum()
    ...
    def x_test_compile_capture(self):
    ...
    def x_test_compile_kwargs(self):
        @mx.compile
        def fun(x, y, z):
            return x + y + z
    ...
    def x_test_shapeless_compile(self):
        y = 1
    ...
    def x_test_shapeless_compile_with_broadcasts(self):
        x = mx.ones((2, 2))
        y = mx.array([2, 2])
    ...
    def x_test_shapeless_compile_with_reduction(self):
    ...
    def x_test_shapeless_compile_unflatten(self):
        x = mx.zeros((1, 1, 4 * 32))
    ...
    def x_test_shapeless_compile_gather(self):
        x = mx.zeros((1, 1, 32))
    ...
    def x_test_shapeless_compile_full_like(self):
        x_shape = (1, 1, 32)
        x = mx.zeros((x_shape))
    ...
    def x_test_shapeless_compile_gather_qmm(self):
    ...
    def x_test_shapeless_compile_gather_mm(self):
        K, N, num_experts = 64, 32, 4
    ...
    def x_test_compile_with_constant(self):
        # Test float
        @partial(mx.compile)
        def fun(x, y):
            return x + y
    ...
    def x_test_unsupported_input_types(self):
        class MyClass:
            value = 1
    ...
    def x_test_compile_create_list(self):
        @mx.compile
        def fun():
    ...
    def x_test_shapeless_mean(self):
        def mean(x):
    ...
    def x_test_compile_broadcast_only(self):
        def fn(a):
    ...
    def x_test_compile_with_long_name(self):
        def fn(a, b):
            for _ in range(10):
                a = a - 1.0
                b = b - 1.0
    ...
    def x_test_compile_multi_output(self):
        def fn(x):
            ys = [x]
            for i in range(5):
                ys.append(ys[-1] + x)
    ...
    def x_test_max_into_equal(self):
    ...
    def x_test_compile_without_captured_inputs(self):
        x = mx.array([1, 2, 3]) + 2
    ...
    def x_test_compile_dynamic_dims(self):
    ...
    def x_test_compile_many_inputs(self):
    ...
    def x_test_compile_many_outputs(self):
        @mx.compile
        def fun(arr):
            arrs = [arr] * 64
            first_arrs = None
    ...
    def x_test_shapeless_compile_matmul(self):
    ...
    def x_test_shapeless_compile_addmm(self):
        def fun(c, a, b):
    ...
    def x_test_shapeless_compile_slice_update(self):
        def fun(x):
            x[2] = mx.array([3.0])
            return x
    ...
    def x_test_shapeless_compile_with_reshape(self):
        def fun(x):
    ...
    def x_test_compile_shapeless_with_broadcast(self):
        a = mx.array(0.0)
        b = mx.ones((2, 2))
    ...
    def x_test_double_constant(self):
    ...
    def x_test_shared_broadcast(self):
        def fun(x, y, z):
    ...
    def x_test_compile_large_graph_with_broadcasts(self):
        N = 20
    ...
    def x_test_compiled_preserves_attributes(self):
    ...
    def x_test_compile_with_none(self):
        @mx.compile
        def fun(x, y):
            if y is None:
                return mx.abs(x - 2.0)
    ...
    def x_test_compile_changing_outputs(self):
        @mx.compile
        def fun(x, y):
            if y is None:
                return 2 * x
    ...
    def x_test_compile_changing_outputs_with_state(self):
        state = [mx.array(1.0)]
    ...
    def x_test_outputs_changing(self):
        @mx.compile
        def fun(x):
    ...
    def x_test_multiple_compile_same_capture(self):
        def fun(do_compile):
            t = mx.ones((10,))
            u = (1.0 - t) * 0.0 + t * 3.0
    ...
    def x_test_compile_output_with_siblings(self):
        @mx.compile
        def fun(x, y):
    ...
    def x_test_compile_donates_input_buffer(self):
