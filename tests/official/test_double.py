...
class TestDouble(mlx_tests.MLXTestCase):
    ...
    def x_test_get_and_set_item(self):
        shape = (3, 3)
        a = mx.random.normal(shape=shape)
    ...
    def x_test_type_promotion(self):
        import zero_mlx as mx
