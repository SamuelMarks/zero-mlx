...
class TestBlas(mlx_tests.MLXTestCase):
    ...
    def x_test_block_masked_matmul(self):
    ...
    def x_test_gather_matmul_grad(self):
    ...
    def x_test_gather_mm_sorted(self):
    ...
    def x_test_gather_mm_sorted_vjp(self):
        def gather_mm_ref(a, b, rhs):
            b = b[rhs]
            return a @ b
