...
class TestArray(mlx_tests.MLXTestCase):
    ...
    def x_test_buffer_protocol_x(self):
        dtypes_list = [
    ...
    def x_test_buffer_protocol_x_ref_counting(self):
        a = mx.arange(3)
        wr = weakref.ref(a)
    ...
    def x_test_buffer_protocol_x_tf(self):
        dtypes_list = [
            (
                mx.bool_,
                tf.bool,
    ...
    def test_add_numpy(self):
        ...
        z = x + y
        print("DEBUG: x.dtype=", x.dtype, "y.dtype=", y.dtype, "z.dtype=", z.dtype)
        self.assertEqual(z.dtype, mx.int32)
        self.assertEqual(z.item(), 3)

    def x_test_dlpack_x(self):
    ...
    def x_test_torch_mps_dlpack_non_cpu_error_x(self):
