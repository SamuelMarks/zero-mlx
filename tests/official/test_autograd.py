...
class TestAutograd(mlx_tests.MLXTestCase):
    ...
    def x_test_jvp_comparison_tangent_dtype(self):
    ...
    def x_test_auxiliary_values(self):
        def fun(x, y):
            l = (x * y).sum()
    ...
    def x_test_scatter_add_vjp(self):
        def fun(src, updates):
    ...
    def x_test_scatter_max_vjp(self):
        def fun(src, updates):
    ...
    def x_test_scatter_min_vjp(self):
        def fun(src, updates):
    ...
    def x_test_slice_update_max_vjp(self):
        def fun(src, updates):
    ...
    def x_test_slice_update_min_vjp(self):
        def fun(src, updates):
    ...
    def x_test_slice_update_add_vjp(self):
        def fun(src, updates):
    ...
    def x_test_slice_update_multiply_vjp(self):
        def fun(src, updates):
    ...
    def x_test_split_against_slice(self):
        def f_split(x):
            a, _, b = x.split(3, -1)
            return (a * b).sum()
    ...
    def x_test_custom_function(self):
    ...
    def x_test_flatten_unflatten_vjps(self):
        def fun(x):
    ...
    def x_test_concatenate_vjps(self):
        def fun(x, y):
    ...
    def x_test_put_along_axis_grads(self):
        a = mx.zeros((5, 1))
        b = mx.ones((2, 1))
    ...
    def x_test_grad_with_copies(self):
        a = mx.array(2.0)
        arrays = [a, a, a]
    ...
    def x_test_grad_ids_pre_post(self):
        def fun(arrs):
            return arrs[0]
    ...
    def x_test_grad_with_inplace_update(self):
        def loss_fn(model):
    ...
    def x_test_autograd_types(self):
    ...
    def x_test_complex_prod_vjp(self):
        def prod(x):
    ...
    def x_test_complex_exp_vjp(self):
    ...
    def x_test_complex_log_vjp(self):
        primal = mx.random.normal((3, 4, 5), dtype=mx.complex64)
        cotangent = mx.random.normal(
            (
                3,
