...
class TestVmap(mlx_tests.MLXTestCase):
    ...
    def x_test_vmap_argreduce(self):
    ...
    def x_test_mismatch_input_sizes(self):
        a = mx.ones((10, 1))
        b = mx.ones((1, 1, 1, 5))
    ...
    def x_test_vmap_const_func(self):
        a = mx.random.uniform(shape=(2, 3, 4))
        b = mx.random.uniform(shape=(4, 3))
    ...
    def x_test_vmap_concatenate(self):
    ...
    def x_test_vmap_take_along_axis(self):
        a = mx.zeros((4, 5, 1))
    ...
    def x_test_vmap_put_along_axis(self):
        a = mx.zeros((4, 5, 1))
    ...
    def x_test_vmap_split_vmap(self):
        def fun(x):
            a, b = mx.split(x, 2, 1)
    ...
    def x_test_vmap_masked_scatter(self):
    ...
    def x_test_broadcast_axes_vmap(self):
