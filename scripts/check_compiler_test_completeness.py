...
def main():
    ...
    test_files = [
        ...
        if f.startswith("test_ops_parity_") and f.endswith(".py")
    ]
    ...
    md_content += "This tracks which ml-switcheroo-compiler operations have a dedicated parity test against MLX in `tests/test_ops_parity_*.py`.\n\n"
